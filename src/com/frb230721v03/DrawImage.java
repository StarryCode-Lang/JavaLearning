...
public class DrawImage extends JFrame {
    com.frb230721v03.actionListener acl = new actionListener();
    ...
    public void createUI() {
        ...
        JPanel buttonPanel = new JPanel(new GridLayout(2, 6)); // 使用GridLayout以网格形式排列按钮
    ...
    public void addButton(JPanel buttonPanel) {
        String[] btnstrs = {"原图", "二值化", "马赛克", "反色", "脸部提亮", "普通黑白", "油画", "融合特效", "轮廓提取", "门格海绵分形", "清空"};
